...
var LOGIN_FORM = document.querySelector('.js-login');
var SIGNUP_FORM = document.querySelector('.js-signup');
...
var setTempStorage = function setTempStorage(path) {
  localStorage.setItem('filerTempStorage', path || '');
};

setTempStorage(null);

var getTempStorage = function getTempStorage() {
  return localStorage.getItem('filerTempStorage');
};

var fileDetails = function fileDetails(file) {
  DETAILS.innerHTML = '';
  var filetype = file.type.toLowerCase();
  var icon = filetype.includes('pdf') ? 'pdf.svg' : filetype.includes('audio') ? 'audio.svg' : filetype.includes('document') ? 'doc.svg' : filetype.includes('text') ? 'text.svg' : filetype.includes('-image') ? 'cdimg.svg' : // filetype.includes('image') ? 'image.svg' :
  filetype.includes('video') ? 'video.svg' : filetype.includes('msdos') ? 'exec.svg' : filetype.includes('application') ? 'pkg.svg' : filetype === 'folder' ? 'folder.svg' : 'unknown.svg';
  var btnDnld = file.type !== 'folder' ? "\n        <button class=\"details__btn js-dnldFile\" data-link=\"".concat(file.name, "\">Download file..</button>\n    ") : '';
  var isImage = file.type.toLowerCase().includes('image/');
  var img = isImage ? '' : "<img class=\"details__image\" src=\"/icons/".concat(icon, "\" alt=\"preview\" />");
  var template = "\n        <div class=\"details__preview\">\n            ".concat(img, "\n        </div>\n\n        <table class=\"details__info\">\n            <tr>\n                <th class=\"details__info__title\">Name: </th>\n                <td class=\"details__info__value\">").concat(file.name, "</td>\n            </tr>\n            <tr>\n                <th class=\"details__info__title\">Type: </th>\n                <td class=\"details__info__value\">").concat(file.type, "</td>\n            </tr>\n            <tr>\n                <th class=\"details__info__title\">Size: </th>\n                <td class=\"details__info__value\">").concat(file.formattedSize, "</td>\n            </tr>\n            <tr>\n                <th class=\"details__info__title\">Date: </th>\n                <td class=\"details__info__value\">").concat(file.birthtime, "</td>\n            </tr>\n        </table>\n        ").concat(btnDnld, "\n    ");
  DETAILS.insertAdjacentHTML('beforeend', template);
  if (isImage) getImagePreview(file);
};

var login = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(email, passwd) {
    var res;
...
var signup = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(name, email, passwd, passwdConfirm) {
    var res;
...
var downloadFile = /*#__PURE__*/function () {
  ...
  return function downloadFile(_x7) {
    return _ref4.apply(this, arguments);
  };
}();

var getImagePreview = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(file) {
    var path, fileName, res, url, img;
  ...
  return function getImagePreview(_x8) {
    return _ref5.apply(this, arguments);
  };
}();

var addDir = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6() {
    var folderName, path, res;
    return regeneratorRuntime.wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            folderName = document.querySelector('.js-input-folder').value;
            path = getTempStorage();
            _context6.prev = 2;
            _context6.next = 5;
            return (0, _axios.default)({
...
var loadFile = /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7() {
    var files, formData, _iterator, _step, file, res;

    return regeneratorRuntime.wrap(function _callee7$(_context7) {
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            files = document.querySelector('.js-input-file').files;
            ...
            _context7.prev = 5;
            _context7.next = 8;
            return _axios.default.post('/files/loadFiles', formData, {
              headers: {
...
var loadFolder = /*#__PURE__*/function () {
    ...
    return regeneratorRuntime.wrap(function _callee8$(_context8) {
      while (1) {
        switch (_context8.prev = _context8.next) {
          case 0:
            parentPath = _args8.length > 1 && _args8[1] !== undefined ? _args8[1] : null;
  ...
  return function loadFolder(_x9) {
    return _ref8.apply(this, arguments);
  };
}();

var renderFolder = function renderFolder(files) {
  var parentPath = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
  var path = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '';
  var toParentPath = path.length === 0 ? '' : "\n        <tr class=\"js-back\" data-attr=\"".concat(parentPath, "\">\n            <td>../</td>\n            <td>&nbsp;</td>\n            <td>&nbsp;</td>\n            <td>&nbsp;</td>\n        </tr>\n    ");
  var template = "    \n        <tr>\n            <th>Name:</th>\n            <th>Type:</th>\n            <th>Size:</th>\n            <th>Date:</th>\n        </tr>\n        ".concat(toParentPath, "\n    ");

  for (var key in files) {
    var file = files[key];
    template += "\n            <tr class=\"js-item\" data-name=\"".concat(key, "\" data-attr='").concat(JSON.stringify(file), "')>\n                <td>").concat(key, "</td>\n                <td>").concat(file.type, "</td>\n                <td>").concat(file.formattedSize, "</td>\n                <td>").concat(new Date(file.birthtime).toLocaleString('en-EN'), "</td>\n            </tr>\n        ");
  }
...
var searchItems = function searchItems(search) {
...
SEARCH && SEARCH.addEventListener('input', function (event) {
  var inputVal = SEARCH.value;
  searchItems(inputVal);
});
MAIN && MAIN.addEventListener('click', function (event) {
  var item = event.target.closest('tr');
  var button = event.target.closest('button');

  if (item && item.classList.contains('js-item')) {
    var file = JSON.parse(item.dataset.attr);
...
MAIN && MAIN.addEventListener('dblclick', function (event) {
  var item = event.target.closest('tr');
  if (!item) return;

  if (item.classList.contains('js-item')) {
    var file = JSON.parse(item.dataset.attr);
    if (file.type === 'folder') return loadFolder(file.localPath ? "".concat(file.localPath, "/").concat(file.name) : file.name, file.localPath);
  }
...
LOGIN_FORM && LOGIN_FORM.addEventListener('submit', function (event) {
  event.preventDefault();
  var email = document.getElementById('email').value;
  var password = document.getElementById('password').value;
  login(email, password);
});
NAVBAR && NAVBAR.addEventListener('click', function (event) {
  var clickLogout = event.target.classList.contains('js-logout');
  var clickAddFile = event.target.classList.contains('js-loadFile');
  var clickAddFolder = event.target.classList.contains('js-addFolder');
  if (clickLogout) logout();
  if (clickAddFile) popupToggle(2);
  if (clickAddFolder) popupToggle(1);
});
SIGNUP_FORM && SIGNUP_FORM.addEventListener('submit', function (event) {
  event.preventDefault();
...
DETAILS && DETAILS.addEventListener('click', function (event) {
  var btn = event.target.closest('.js-dnldFile');
  if (!btn) return;
  var file = btn.dataset.link;
  downloadFile(file);
});
